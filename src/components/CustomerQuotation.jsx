  ...
  return (
    <div className="quotation-preview">
      ...
      <div className="card print-sheet" style={{ padding: "3rem", color: "#1a1a1a", position: "relative", border: "2px solid #1A3636" }}>
        {/* Header Design */}
        <header className="mobile-stack" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", borderBottom: "4px solid #1A3636", paddingBottom: "1.5rem", marginBottom: "2rem", gap: "1rem" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "1.5rem" }}>
            <img src={logo} alt="Logo" style={{ height: "60px", width: "60px" }} />
            <div>
              <h1 className="brand-font" style={{ fontSize: "2rem", lineHeight: "1", color: "#1A3636", marginBottom: "0.2rem" }}>EVENTRA</h1>
              <div style={{ letterSpacing: "2px", fontSize: "0.8rem", fontWeight: "600", color: "#D6BD98" }}>EVENTS & CATERING</div>
            </div>
          </div>
          <div className="mobile-stack" style={{ textAlign: "right" }}>
            <div style={{ background: "#1A3636", color: "white", padding: "0.4rem 1rem", fontWeight: "700", letterSpacing: "2px", borderRadius: "4px", marginBottom: "0.5rem", textAlign: "center" }}>QUOTATION</div>
            <div style={{ fontSize: "0.8rem" }}>
              <div style={{ fontWeight: "700" }}>{branch.name}</div>
              <div className="mobile-hide">{branch.addr}</div>
        ...
        {/* Info Grid */}
        <div className="responsive-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1px", background: "#E0E0E0", border: "1px solid #E0E0E0", borderRadius: "8px", overflow: "hidden", marginBottom: "2rem" }}>
          {[
            ...
            <div key={label} style={{ background: "white", padding: "0.8rem 1.2rem", display: "flex", gap: "1rem" }}>
              <span style={{ fontSize: "0.65rem", fontWeight: "700", color: "#757575", width: "60px", flexShrink: 0 }}>{label}</span>
        ...
        {/* Totals and Terms */}
        <div className="responsive-grid-2" style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr", gap: "2rem" }}>
          ...
          <div style={{ background: "#1A3636", color: "white", borderRadius: "8px", padding: "1.2rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.5rem", fontSize: "0.8rem" }}>
              <span>Total Contract Value</span>
              <span style={{ fontWeight: "700" }}>₹ {parseFloat(evt.totalRate || 0).toLocaleString("en-IN")}</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.5rem", color: "#D6BD98", fontSize: "0.8rem" }}>
              <span>Advance Paid</span>
              <span>₹ {parseFloat(evt.cashAdvance || 0).toLocaleString("en-IN")}</span>
            </div>
            <div style={{ borderTop: "1px solid rgba(255,255,255,0.2)", marginTop: "1rem", paddingTop: "1rem", display: "flex", justifyContent: "space-between", fontSize: "1rem" }}>
